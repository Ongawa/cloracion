...
public class PipeRecord extends UpdatableRecordImpl<PipeRecord> implements Record9<Integer, Integer, Integer, Integer, String, Double, Double, Integer, Double> {

	private static final long serialVersionUID = 1619360884;
	...
	/**
	 * Setter for <code>PUBLIC.PIPE.REQUIREDCONCENTRATION</code>.
	 */
	...
	/**
	 * Getter for <code>PUBLIC.PIPE.REQUIREDCONCENTRATION</code>.
	 */
	 ...
	 */
	@Override
	public Row9<Integer, Integer, Integer, Integer, String, Double, Double, Integer, Double> fieldsRow() {
	 ...
	 */
	@Override
	public Row9<Integer, Integer, Integer, Integer, String, Double, Double, Integer, Double> valuesRow() {
	...
	public Field<Double> field9() {
		return Pipe.PIPE.REQUIREDCONCENTRATION;
	}
	 ...
	 */
	@Override
	public PipeRecord value9(Double value) {
	 ...
	 */
	@Override
	public PipeRecord values(Integer value1, Integer value2, Integer value3, Integer value4, String value5, Double value6, Double value7, Integer value8, Double value9) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public PipeRecord(Integer idpipe, Integer watersystemIdwatersystem, Integer watersystemCommunityIdcommunity, Integer watersystemCommunitySubbasinIdsubbasin, String name, Double diameter, Double length, Integer count, Double requiredconcentration) {
		super(Pipe.PIPE);
		...
		setValue(6, length);
		setValue(7, count);
		setValue(8, requiredconcentration);
	}
}
