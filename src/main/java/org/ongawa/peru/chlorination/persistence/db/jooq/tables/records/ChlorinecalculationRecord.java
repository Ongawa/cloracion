...
public class ChlorinecalculationRecord extends UpdatableRecordImpl<ChlorinecalculationRecord> implements Record14<Timestamp, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Integer, Double, Double, Double> {

	private static final long serialVersionUID = 98038231;
	 ...
	 */
	@Override
	public Row14<Timestamp, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Integer, Double, Double, Double> fieldsRow() {
	 ...
	 */
	@Override
	public Row14<Timestamp, Integer, Integer, Integer, Integer, Double, Double, Double, Double, Double, Integer, Double, Double, Double> valuesRow() {
	 ...
	 */
	@Override
	public ChlorinecalculationRecord values(Timestamp value1, Integer value2, Integer value3, Integer value4, Integer value5, Double value6, Double value7, Double value8, Double value9, Double value10, Integer value11, Double value12, Double value13, Double value14) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
